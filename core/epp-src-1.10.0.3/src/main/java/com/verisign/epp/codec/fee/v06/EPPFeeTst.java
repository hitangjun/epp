...
/**
 * Is a unit test of the com.verisign.epp.codec.fee.v06 package. The unit test
 * will execute, gather statistics, and output the results of a test of each
 * com.verisign.epp.codec.fee.v06 package concrete extension
...
public class EPPFeeTst extends TestCase {
	...
	public void testDomainCheck() {
		...
		theFeeResult = new EPPFeeDomainResult("example.org", "EUR",
				new EPPFeeCommand("transfer"), new EPPFeePeriod(2));
		...
		theFeeResult = new EPPFeeDomainResult("example.xyz", "GDB",
				new EPPFeeCommand("restore"), new EPPFeePeriod(1));
	...
	public void testDomainInfo() {
		...
		EPPFeeInfData theInfDataExt = new EPPFeeInfData("USD",
				new EPPFeeCommand("create", EPPFeeCommand.PHASE_SUNRISE),
				new EPPFeePeriod(1));
	...
	public void testDomainCreate() {
		...
		EPPFeeCreate theCreateExt = new EPPFeeCreate("USD", new EPPFeeValue(
				new BigDecimal("5.00")));
	...
	public void testDomainRenew() {
		...
		EPPFeeRenew theRenewExt = new EPPFeeRenew("USD", new EPPFeeValue(
				new BigDecimal("5.00")));
	...
	public void testDomainUpdate() {
		...
		EPPFeeUpdate theUpdateExt = new EPPFeeUpdate("USD", new EPPFeeValue(
				new BigDecimal("5.00")));
	...
	public void testDomainTransfer() {
		...
		EPPFeeTransfer theTransferExt = new EPPFeeTransfer("USD",
				new EPPFeeValue(new BigDecimal("5.00")));
