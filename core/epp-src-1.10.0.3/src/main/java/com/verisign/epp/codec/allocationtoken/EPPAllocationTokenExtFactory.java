...
/**
 * Factory for the Allocation Token Extension objects. The Allocation Token Extension only
 ...
 */
public class EPPAllocationTokenExtFactory extends EPPExtFactory {
	/** XML Namespace */
	public static final String NS = "urn:ietf:params:xml:ns:allocationToken-1.0";

	/** XML Namespace Prefix */
	public static final String NS_PREFIX = "allocationToken";

	/** EPP Namestore Extension XML Schema. */
	public static final String NS_SCHEMA = "urn:ietf:params:xml:ns:allocationToken-1.0 allocationToken-1.0.xsd";

	/**
	 * Service object associated with EPPAllocationTokenExtFactory. The service
	 * object is used when creating the Greeting or the Login.
	 */
	private EPPService service;

	/**
	 * Default constructor for <code>EPPAllocationTokenExtFactory</code>.
	 */
	public EPPAllocationTokenExtFactory() {
	...
	public EPPCodecComponent createExtension(Element aExtensionElm)
		...
		if (name.equals(EPPUtil.getLocalName(EPPAllocationToken.ELM_NAME))) {
			return new EPPAllocationToken();
		}
		else {
	...
	public EPPProtocolExtension createProtocolExtension(Element aExtensionElm)
		...
		throw new EPPCodecException(
				"EPPAllocationTokenExtFactory.createProtocolExtension: Protocol extensions not supported");
	}
	...
	public Set getXmlSchemas() {
		...
		theSchemas.add("allocationToken-1.0.xsd");
		return theSchemas;
	}
