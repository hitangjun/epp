 ...
 ***********************************************************/
package com.verisign.epp.interfaces.v06;
...
public class EPPFeeDomainTst extends TestCase {
	...
	public void domainCreate() {
		...
		try {
			...
			domain.addExtension(new EPPFeeCreate("USD", new EPPFeeValue(
					new BigDecimal("5.00"))));
	...
	public void domainRenew() {
		...
		try {
			...
			domain.addExtension(new EPPFeeRenew("USD", new EPPFeeValue(
					new BigDecimal("5.00"))));
	...
	public void domainUpdate() {
		...
		try {
			...
			domain.addExtension(new EPPFeeUpdate("USD", new EPPFeeValue(
					new BigDecimal("5.00"))));
	...
	public void domainTransfer() {
		...
		try {
			...
			domain.addExtension(new EPPFeeTransfer("USD", new EPPFeeValue(
					new BigDecimal("5.00"))));
