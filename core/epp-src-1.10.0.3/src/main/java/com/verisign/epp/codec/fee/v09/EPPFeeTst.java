...
/**
 * Is a unit test of the com.verisign.epp.codec.fee.v09 package. The unit test
 * will execute, gather statistics, and output the results of a test of each
 * com.verisign.epp.codec.fee.v09 package concrete extension
...
public class EPPFeeTst extends TestCase {
	...
	public void testDomainCheck() {
		...
		theCheckExt.addObject(new EPPFeeObject("example.com", "USD",
				new EPPFeeCommand("create", EPPFeeCommand.PHASE_SUNRISE),
				new EPPFeePeriod(1)));
		theCheckExt.addObject(new EPPFeeObject("example.net", "EUR",
				new EPPFeeCommand("create", EPPFeeCommand.PHASE_CLAIMS,
						EPPFeeCommand.PHASE_LANDRUSH), new EPPFeePeriod(2)));
		theCheckExt.addObject(new EPPFeeObject("example.org", "EUR",
				new EPPFeeCommand("transfer"), null));
		theCheckExt.addObject(new EPPFeeObject("example.xyz",
		...
		// example.com result
		theFeeResult = new EPPFeeObjectResult("example.com", "USD",
				new EPPFeeCommand("create", EPPFeeCommand.PHASE_SUNRISE));
		...
		// example.net result
		theFeeResult = new EPPFeeObjectResult("example.net", "EUR",
				new EPPFeeCommand("create", EPPFeeCommand.PHASE_CLAIMS,
						EPPFeeCommand.PHASE_LANDRUSH), new EPPFeePeriod(2),
		...
		// example.org result
		theFeeResult = new EPPFeeObjectResult("example.org", "EUR",
		...
		// example.xyz result
		theFeeResult = new EPPFeeObjectResult("example.xyz", "GDB",
				new EPPFeeCommand("restore"));
