...
package com.verisign.epp.serverstub.v09;
...
import com.verisign.epp.codec.fee.v09.EPPFeeObjectResult;
 ...
 */
public class FeeV09DomainHandler implements FeeSubDomainHandler {

	/**
	 * Log4j category for logging
	 */
	private static Logger cat = Logger.getLogger(FeeV09DomainHandler.class
	...
	public void doDomainCheck(EPPDomainCheckCmd aCheckCommand,
		...
		for (EPPFeeObject domain : theFeeExt.getObjects()) {

			// Set the base result attributes
			theFeeResult = new EPPFeeObjectResult();
			theFeeResult.setObjID(domain.getObjID());
			...
			if (domain.getObjID().equalsIgnoreCase("example.com")) {
				theFeeResult.setCurrency("USD");
			...
			else if (domain.getObjID().equalsIgnoreCase("example.net")) {
				theFeeResult.setCurrency("EUR");
				theFeeResult.addFee(new EPPFeeValue(new BigDecimal("5.00")));
			}
			else if (domain.getObjID().equalsIgnoreCase("example.org")) {
				theFeeResult.setCurrency("EUR");
			...
			else if (domain.getObjID().equalsIgnoreCase("example.xyz")) {
