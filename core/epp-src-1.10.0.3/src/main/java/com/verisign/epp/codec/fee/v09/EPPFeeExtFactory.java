...
public class EPPFeeExtFactory extends EPPExtFactory {
	/** XML Namespace */
	public static final String NS = "urn:ietf:params:xml:ns:fee-0.9";

	/** XML Namespace Prefix */
	public static final String NS_PREFIX = "fee";

	/** EPP Namestore Extension XML Schema. */
	public static final String NS_SCHEMA = "urn:ietf:params:xml:ns:fee-0.9 fee-0.9.xsd";
