...
public class EPPFeeRenew extends EPPFeeTransform {
	...
	/**
	 * Constructor for <code>EPPFeeRenew</code> that takes the required currency
	 ...
	 *            A single fee value
	 */
	public EPPFeeRenew(String aCurrency, EPPFeeValue aFee) {
	 ...
	 *            List of fees
	 */
	public EPPFeeRenew(String aCurrency, List<EPPFeeValue> aFees) {
