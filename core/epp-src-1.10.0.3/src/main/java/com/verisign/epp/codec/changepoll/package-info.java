 ...
 * The classes in this package can be used to create a change poll extension 
 * object that can be encoded to XML and decoded from XML.  The 
 * <code>EPPChangePollExtFactory</code> must be registered with the <code>EPPFactory</code>
 * to be able to decode the XML into change poll extension objects.  The 
 * <code>EPPChangePollTst</code> class can be used to unit test all of the classes 
