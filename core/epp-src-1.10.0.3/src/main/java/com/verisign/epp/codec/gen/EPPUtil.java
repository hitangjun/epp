...
public class EPPUtil {
	...
	/**
	 * Gets the XML Schema <code>timeDate</code> format used in
	 * {@link #encodeTimeInstant(Date) and #encodeTimeInstant(Document, Element,
	 ...
	 * 
	 * @return XML Schema <code>timeDate</code> format used in
	...
	/**
	 * Sets the XML Schema <code>timeDate</code> format used in
	 * {@link #encodeTimeInstant(Date) and #encodeTimeInstant(Document, Element,
	 * Date, String, String)}. The format must follow the format supported by
	 * {@link SimpleDateFormat}.
	 * 
	 * @param aTimeInstantFormat
	 *            XML Schema <code>timeDate</code> format supported by
	 *            {@link SimpleDateFormat}.
	 */
	...
	/**
	 * Decode <code>BigDecimal</code>, from an XML Element. The
	 * <code>aElement</code> element will be decoded and returned. If element is
	 * <code>null</code>, <code>null</code> is returned.
	 * 
	 * @param aElement
	 *            XML Element to decode.
	 * @return <code>BigDecimal</code> value if <code>aElement</code> is not
	 *         <code>null</code>; <code>null</code> otherwise.
	 * @exception EPPDecodeException
	 *                Error decoding <code>aElement</code>.
	 */
	public static BigDecimal decodeBigDecimal(Element aElement)
	 ...
	 * @return Attribute <code>String</code> value if exists; <code>null</code>
	 *         otherwise.
	 */
	...
	/**
	 * Decode <code>String</code> value from an XML Element.
	 * 
	 * @param aElement
	 *            XML Element to get the <code>String</code> value.
	 * @return <code>String</code> value if set; &quot;&quot; other.
	 * @exception EPPDecodeException
	 *                Error decoding <code>aElement</code>.
	 */
	...
	public static Date decodeTimeInstant(String aTimeInstant) {
		...
		try {
			...
			cat.error("Exception decoding dateTime \"" + aTimeInstant + "\": "
					+ ex);
			theDate = null;
		}
	 ...
	 *            <code>null</code> is passed, the default format of
	 *            &quot;#0.00&quot; is used.
	 ...
	 * @param aBigDecimal
	 *            <code>Double</code> to encode into the text node of the
	 *            element.
	 * @param aFormat
	 *            Format to use following the {@link DecimalFormat} format. If
	 *            <code>null</code> is passed, the default format of
	 ...
	 *                Error encoding the <code>Double</code>.
	 */
	public static void encodeBigDecimal(Document aDocument, Element aElement,
			BigDecimal aBigDecimal, String aFormat) throws EPPEncodeException {
	 ...
	 *            node could be &ltdomain:update&gt
	 * @param aVector
	 *            <code>Vector</code> of <code>EPPCodecComponent's</code> to
	 *            add.
	 * @exception EPPEncodeException
	 ...
	 * is passed, it will be simply returned back.
	 * 
	 ...
	 * @throws Exception
	 *             Error encoding the <code>Element</code>
	 */
