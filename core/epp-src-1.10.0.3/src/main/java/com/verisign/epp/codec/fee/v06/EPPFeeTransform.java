...
public abstract class EPPFeeTransform implements EPPCodecComponent {
	...
	/**
	 * Constructor for <code>EPPFeeTransform</code> that takes the required
	 ...
	 */
	public EPPFeeTransform(String aCurrency, EPPFeeValue aFee) {
	 ...
	 */
	public EPPFeeTransform(String aCurrency, List<EPPFeeValue> aFees) {
		this.setCurrency(aCurrency);
		this.setFees(aFees);
	}
	...
	public Element encode(Document aDocument) throws EPPEncodeException {
		...
		if (this.currency == null) {
			throw new EPPEncodeException(
					"Required currency attribute is null in EPPFeeTransform.encode(Document).");
		}
