 ...
 * 
 * @see com.verisign.epp.codec.fee.v07.EPPFeeInfo
 */
public class EPPFeeInfData implements EPPCodecComponent {
	 ...
	 * @param aFee
	 *            A single fee. More can be added by calling {
	 *            {@link #addFee(EPPFeeValue)}.
	 */
	...
	public Element encode(Document aDocument) throws EPPEncodeException {
		...
		if (!this.hasFees()) {
			throw new EPPEncodeException(
					"There must be at least one fee in EPPFeeInfData.encode(Document).");
		}
	...
	public boolean equals(Object aObject) {
		...
		if (!EqualityUtil.equals(this.credits, other.credits)) {
			cat.error("EPPFeeInfData.equals(): credits not equal");
			return false;
		}
