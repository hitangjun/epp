 ...
 * available. <code>domain reason</code> must be set before invoking
...
public class EPPDomainCheckResult implements EPPCodecComponent {
	...
	/**
	 * Default constructor for <code>EPPDomainCheckResult</code>. the defaults
	 * include the following: <br>
	 * <br>
	 * 
	 * <ul>
	 * <li>
	 * name is set to <code>null</code></li>
	 * <li>
	 * available is set to <code>true</code></li>
	 * </ul>
	 * 
	 * <br>
	 * The name must be set before invoking <code>encode</code>.
	 */
	 ...
	 *            Is the domain available?
	 * @param aReason
	 *            Reason that domain is not available
	 */
	public EPPDomainCheckResult(String aName, boolean aIsAvailable,
			String aReason) {
		this.name = aName;
	...
	/**
	 * Constructor for <code>EPPDomainCheckResult</code> that includes all
	 * attributes.
	 *
	 * @param aName
	 *            Domain name associated with result
	 ...
	 *
	 * @return Is the domain available? If <code>false</code>, call
	 *         {@link #getDomainReason()} for inavailability reason.
	 */
	 ...
	 *                Unable to encode <code>EPPDomainCheckResult</code>
	 *                instance.
	 */
	public Element encode(Document aDocument) throws EPPEncodeException {
		...
		if (reason != null) {
			Element reasonElm = aDocument.createElementNS(
					EPPDomainMapFactory.NS, ELM_DOMAIN_REASON);
	...
	/**
	 * Decode the <code>EPPDomainCheckResult</code> attributes from the aElement
	 * DOM Element tree.
	 *
	 * @param aElement
	 *            Root DOM Element to decode <code>EPPDomainCheckResult</code>
	 *            from.
	 *
	...
	/**
	 * Compare an instance of <code>EPPDomainPingResp</code> with this instance.
	 *
	 * @param aObject
