...
/**
 * <code>EPPContactMapFactory</code> represents the <code>EPPCommand</code> and <code>EPPResponse</code> factory for the
 * EPP Contact Mapping with the XML Namespace URI "urn:iana:xmlns:contact". The fully qualified class name for
 * <code>EPPContactMapFactory</code> is included in a call to <code>EPPFactory.init</code> or <code>EPPCodec.init</code>
 * . <br>
 * <br>
 *
 * @author $Author: jim $
...
public class EPPContactMapFactory extends EPPMapFactory {
	...
	/**
	 * XML tag name associated with contact authorization information. This value will be passed to the authInfo object
	 * when it is initialized in contact command mappings.
	 */
	...
	/**
	 * Allocates a new <code>EPPContactMapFactory</code>. The service attribute will be initialized with the XML namespace
	 * information defined by the <code>EPPContactMapFactory</code> constants:<br>
	 * <ul>
	 * <li>NS_PREFIX Namespace prefix of <code>EPPContactMapFactory</code></li>
	 * <li>NS Namespace URI of <code>EPPContactMapFactory</code></li>
	 * <li>NS_SCHEMA Namespace schema reference of <code>EPPContactMapFactory</code></li>
	 * </ul>
	 */
	...
	/**
	 * creates a concrete <code>EPPCommand</code> from the passed in XML Element tree. <code>aMapElement</code> must be
	 * the root node for the command extension. For example, &lt;contact:create&gt; must be the element passed for a
	 * Contact Create Command.
	 *
	 * @param aMapElement
	 *        Mapping Extension EPP XML Element.
	 * @return Concrete <code>EPPCommand</code> instance associated with <code>aMapElement</code>.
	...
	/**
	 * creates a concrete <code>EPPResponse</code> from the passed in XML Element tree. <code>aMapElement</code> must be
	 * the root node for the command extension. For example, &lt;contact:info-data&gt; must be the element passed for a
	 * Contact Info Response.
	 *
	 * @param aMapElement
	 *        Mapping Extension EPP XML Element.
	 * @return Concrete <code>EPPResponse</code> instance associated with <code>aMapElement</code>.
	 * @exception EPPCodecException
	...
	/**
	 * Gets the <code>EPPService</code> associated with <code>EPPContactMapFactory</code>. The <code>EPPService</code> is
	 * used by <code>EPPFactory</code> for distributing the responsibility of creating concrete <code>EPPCommand</code>
	 * and <code>EPPResponse</code> objects by XML namespace. The XML namespace is defined in the returned
	 ...
	 *
	 * @return <code>Set</code> of <code>String</code> XML Schema names that should be pre-loaded in the XML Parser.
