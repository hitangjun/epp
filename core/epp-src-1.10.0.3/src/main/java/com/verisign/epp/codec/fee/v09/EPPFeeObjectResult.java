...
public class EPPFeeObjectResult implements EPPCodecComponent {
	 ...
	 */
	private static Logger cat = Logger.getLogger(EPPFeeObjectResult.class
	 ...
	 */
	public EPPFeeObjectResult(String aObjID, String aCurrency,
	...
	/**
	 * Constructor for <code>EPPFeeObjectResult</code> that takes all
	 * attributes.
	 * 
	 * @param aObjID
	 *            Object identifier 
	...
	public boolean equals(Object aObject) {
		...
		if (!EqualityUtil.equals(this.objElement, other.objElement)) {
			cat.error("EPPFeeObjectResult.equals(): objElement not equal");
			return false;
		}
