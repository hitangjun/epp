...
/**
 * Factory for the IDN Map Extension objects. The IDN Map Extension only
 ...
 */
public class EPPIdnMapExtFactory extends EPPExtFactory {
	/** XML Namespace */
	...
	public static final String NS_SCHEMA = "urn:ietf:params:xml:ns:idn-1.0 idn-1.0.xsd";
	...
	public EPPCodecComponent createExtension(Element aExtensionElm)
		...
		if (name.equals(EPPUtil.getLocalName(EPPIdnMap.ELM_NAME))) {
	...
	public EPPProtocolExtension createProtocolExtension(Element aExtensionElm)
		...
		throw new EPPCodecException(
				"EPPIdnMapExtFactory.createProtocolExtension: Protocol extensions not supported");
	}
