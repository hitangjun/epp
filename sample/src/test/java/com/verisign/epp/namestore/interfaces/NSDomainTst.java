...
public class NSDomainTst extends TestCase {
	...
	public void testRelatedDomainCreate() {
		...
		try {
			...
			try {
				...
				// -- Output all of the response attributes
				System.out.println("testRelatedDomainCreate: Response = ["
						+ theResponse + "]\n\n");
				...
				if (theResponse
					...
					System.out
							.println("testRelatedDomainCreate: EPPRelatedDomainExtCreateResp = ["
	...
	/**
	 * Unit test of <code>EPPDomain.sendCreate</code> for secDNS 1.1 using the
	...
	public void testCreateDsDataInterface() {
		...
		try {
			...
			try {
				...
				System.out
						.println("testCreateDsDataInterface(1): domain = "
								+ theDomainName
				...
				// -- Output all of the response attributes
				System.out.println("testCreateDsDataInterface(1): Response = ["
						+ theResponse + "]\n\n");
			}
			catch (Exception ex) {
				TestUtil.handleException(theSession, ex);
			...
			try {
				...
				System.out
						.println("testCreateDsDataInterface(2): domain = "
								+ theDomainName
				...
				// -- Output all of the response attributes
				System.out.println("testCreateDsDataInterface(2): Response = ["
						+ theResponse + "]\n\n");
			}
			catch (Exception ex) {
				TestUtil.handleException(theSession, ex);
	...
	/**
	 * Unit test of <code>EPPDomain.sendUpdate</code> for secDNS 1.1 using the
	 * DS Data Interface. The VeriSign servers only support the DS Data
	 * Interface. The following tests will be executed:<br>
	 * <ol>
	...
	public void testUpdateDsDataInterface() {
		...
		try {
			...
			try {
				...
				System.out
						.println("testUpdateDsDataInterface(1): domain = "
								+ theDomainName
				...
				// -- Output all of the response attributes
				System.out.println("testUpdateDsDataInterface(1): Response = ["
						+ theResponse + "]\n\n");
			}
			catch (Exception ex) {
				TestUtil.handleException(theSession, ex);
			...
			try {
				...
				System.out
						.println("testUpdateDsDataInterface(2): domain = "
								+ theDomainName
				...
				// -- Output all of the response attributes
				System.out.println("testUpdateDsDataInterface(2): Response = ["
						+ theResponse + "]\n\n");
			}
			catch (Exception ex) {
				TestUtil.handleException(theSession, ex);
			...
			try {
				...
				System.out
						.println("testUpdateDsDataInterface(3): domain = "
								+ theDomainName
				...
				// -- Output all of the response attributes
				System.out.println("testUpdateDsDataInterface(3): Response = ["
						+ theResponse + "]\n\n");
			}
			catch (Exception ex) {
				TestUtil.handleException(theSession, ex);
	...
	public void testDomainCheck() {
		...
		try {
			...
			try {
				...
				System.out
						.println("nonPremiumDomainCheck: Check single domain name With Flag True ("
								+ theDomainName + ")");
			...
			try {
				...
				System.out
						.println("premiumDomainCheck: Check single domain name With Flag True ("
								+ theDomainName + ")");
					...
					for (int i = 0; i < premiumDomainCheckResponse
						...
						if (currResult.isPremium()) {
							...
							if (currResult.getPrice() != null) {
								System.out
										.println("domainCheck: Premium price is $"
												+ currResult.getPrice());
								System.out
										.println("domainCheck: Premium renewal price is $"
	...
	public void testDomainInfo() {
		...
		try {
			...
			try {
				...
				if (theResponse.hasExtension(EPPCoaExtInfData.class)) {
					...
					for (Iterator iterator = coaInfData.getAttrs().iterator(); iterator
						...
						System.out.println("Client Object Attribute: key='"
								+ key + "', value='" + value + "'");
			...
			try {
				...
				// -- Output all of the response attributes
				System.out
						.println("domainInfo: Response for graceperiod.com = ["
								+ theResponse + "]\n\n");
				...
				// -- Output all of the response attributes
				System.out
						.println("domainInfo: Response for pendingperiod.com = ["
								+ theResponse + "]\n\n");
	...
	public void testAllocationToken() {
		...
		try {
			...
			try {
				...
				// -- Output all of the response attributes
				System.out.println("testAllocationToken: Check Response = ["
						+ theResponse + "]\n\n");
			...
			try {
				...
				// -- Output all of the response attributes
				System.out.println("testAllocationToken: Info Response = ["
						+ theResponse + "]\n\n");
			...
			try {
				...
				theDomain.addContact("sh8013", NSDomain.CONTACT_ADMINISTRATIVE);
				theDomain.addContact("sh8013", NSDomain.CONTACT_TECHNICAL);
				theDomain.setAuthString("2fooBAR");
				theDomain.setAllocationToken("abc123");
				...
				// -- Output all of the response attributes
				System.out.println("testAllocationToken: Create Response = ["
						+ theResponse + "]\n\n");
			...
			try {
				...
				theDomain.setSubProductID("tld");
				theDomain.setAuthString("2fooBAR");
				theDomain.setTransferOpCode(NSDomain.TRANSFER_REQUEST);
				...
				// -- Output all of the response attributes
				System.out.println("testAllocationToken: Transfer Response = ["
						+ theResponse + "]\n\n");
			...
			try {
				...
				// -- Output all of the response attributes
				System.out.println("testAllocationToken: Update Response = ["
						+ theResponse + "]\n\n");
	...
	/**
	 * Unit test using {@link NSDomain#setResellerId(String)} to set the
	 * reseller identifier on create and
	 * {@link NSDomain#updateResellerId(com.verisign.epp.codec.resellerext.EPPResellerExtUpdate.Action, String)}
	...
	public void testAsyncCommands() {
		...
		try {
			...
			if (!theSession.isModeSupported(EPPSession.MODE_ASYNC)) {
				System.out.println("testAsyncCommands: Session "
			...
			try {
				while (clientTransIdQueue.size() > 0) {
					...
					if (theClientTransId.equals(theResponse.getTransId()
							.getClientTransId())) {
						System.out
								.println("Successfully received client transaction id "
	...
	public void testDomainCoaUpdate() {
		...
		try {
			...
			try {
				...
				// -- Output all of the response attributes
				System.out.println("domainUpdate adding a COA: Response = ["
						+ theResponse + "]\n\n");
			...
			try {
				...
				// -- Output all of the response attributes
				System.out.println("domainUpdate removing a COA: Response = ["
						+ theResponse + "]\n\n");
