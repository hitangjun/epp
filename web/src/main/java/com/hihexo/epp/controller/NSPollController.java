...
public class NSPollController extends BaseNSController {
	...
	@ApiOperation(value="Poll", notes="handling of NameStore poll messages.  This\n" +
			" * also functions as a sample for handling all of the possible\n" +
			" * poll messages generated by NameStore")

	@ApiImplicitParams({
			@ApiImplicitParam(name = "domainName", value = "域名", required = true, dataType = "String"),
			@ApiImplicitParam(name = "authStr", value = "认证信息", required = true, dataType = "String")
	})
	@RequestMapping(value = "/send", method= RequestMethod.POST)
	@SystemControllerLog(description = "pollmessage")
	@ResponseBody
	public Object poll(HttpServletRequest request) {
		printStart("Poll");
