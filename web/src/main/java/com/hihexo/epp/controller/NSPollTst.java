...
public class NSPollTst extends TestCase {
	...
	/** Logging category */
	private static final Logger cat = Logger.getLogger(com.verisign.epp.namestore.interfaces.NSPollTst.class
	...
	public static Test suite() {
		return new NSPollTstSetup(new TestSuite(com.verisign.epp.namestore.interfaces.NSPollTst.class));
	}
		...
		if (numThreads > 1) {
			...
			for (int i = 0; i < numThreads; i++) {
				TestThread thread = new TestThread("NSPollTst Thread " + i,
						com.verisign.epp.namestore.interfaces.NSPollTst.suite());
				thread.start();
			}
		}
		else { // Single threaded mode.
			junit.textui.TestRunner.run(com.verisign.epp.namestore.interfaces.NSPollTst.suite());
		}
